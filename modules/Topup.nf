process Topup {
    ...
    """
      ...
      scil_volume_math.py convert $rev_b0 $rev_b0 -f --data_type float32
      scil_volume_math.py convert $b0 $b0 -f --data_type float32
      scil_volume_math.py concatenate $rev_b0 $rev_b0 ${sid}__concatenated_rev_b0.nii.gz
      scil_volume_math.py mean ${sid}__concatenated_rev_b0.nii.gz ${sid}__rev_b0_mean.nii.gz
      ...
      scil_dwi_prepare_topup_command.py $b0 ${sid}__rev_b0_warped.nii.gz\
